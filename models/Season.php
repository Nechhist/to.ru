...
class Season extends \yii\db\ActiveRecord
{
    ...
    public static function nets($i=0, $id=0){
        $nets = [
            ...
            '10004' => ['id'=>10004, 'name'=>'Дерево-4', 'opisanie'=>'Дерево с 4 участниками, без 3 места, без лузеров', 'type'=>'1', 'count'=>'4', '3place'=>'0', 'luser'=>'0', 'example'=>1],
            '11004' => ['id'=>11004, 'name'=>'Дерево-4т', 'opisanie'=>'Дерево с 4 участниками, с 3 местом, без лузеров', 'type'=>'1', 'count'=>'4', '3place'=>'1', 'luser'=>'0', 'example'=>2],
            '11104' => ['id'=>11104, 'name'=>'Дерево-4тл', 'opisanie'=>'Дерево с 4 участниками, с 3 местом, с лузерами', 'type'=>'1', 'count'=>'4', '3place'=>'1', 'luser'=>'1', 'example'=>15],
            ...
            // ГРУППЫ
            // первая цифра - тип турнирной сетки, 2 - группы
            // вторая цифра - кол-во групп (2 группы, 4 группы)
            // третья цифра - кол-во участников в группе (4 участник, 8 участников)
            '22408' => ['id'=>22408, 'name'=>'Группы-8(2х4)', 'opisanie'=>'Группы с 8 участниками (2 группы по 4 участника)', 'type'=>'2', '3place'=>'4', 'count'=>'8', 'luser'=>'4', 'example'=>42],
            '24416' => ['id'=>24416, 'name'=>'Группы-16(4х4)', 'opisanie'=>'Группы с 16 участниками (4 группы по 4 участника)', 'type'=>'2', '3place'=>'2', 'count'=>'16', 'luser'=>'4', 'example'=>43],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'unit_type' => '(в разработке) Тип участников',
            'time_action' => 'Время проведения',
            'score_open' => 'Показ побед/очков',
            'invisible' => 'Режим показа',
            'zayavka_open' => '(в разработке) Прием заявок',
            'net_type' => 'Вид турнирной сетки',
            'label' => '(отключено/в разработке) Название столбцов',
            'unit1' => 'Unit1',
            'unit2' => 'Unit2',
            'unit3' => 'Unit3',
            'unit4' => 'Unit4',
